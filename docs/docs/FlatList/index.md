...
## **useSkiaFlatList**([`SkiaFlatListProps<T,A>`](FlatList/index.md#skiaflatlistprops)): [`SkiaFlatListState<T,A>`](FlatList/index.md#skiaflatliststate)
...
### getItemFromTouch: `(e) => `[`TapResult<T>`](FlatList/index.md#tapresult)` | undefined`
